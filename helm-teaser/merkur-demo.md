# Live cluster demo (facilitator cheat-sheet) — Merkur on Nota-BETA k8s cluster
...
## A. During "Kubernetes Cluster" — multi-node, which local can't show
...
## G. At the Helm teaser (see [../helm-teaser](./README.md)) — the killer example
